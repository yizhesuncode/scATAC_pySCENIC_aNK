# Epigenetic regulation analysis for ovarian tumor-associated adaptive NK Cell using scATAC 
# workflow (from public dataset) and PySCENIC (from our smartseq3 data)
